...
public class WordFrequencyCalculator {
     ...
     * Input:  List<String>. Examples: ["Apple", "Horse", "apple", "ApplE", "Minute", "masquerade", "Mask", "water", "Water"], ["Word", "A", "AA", "a", "aaa", "aa"], etc.
    ...
    /**
     * Task:   Find every word with odd frequency (odd number of occurrence) in the given List of Strings!
     * Input:  List<String>. Examples: ["Apple", "Horse", "apple", "ApplE", "Minute", "masquerade", "Mask", "water", "Water"], ["Word", "A", "AA", "a", "aaa", "aa"], etc.
     * Output: Map<String, Long> where the key is the word and the value is the frequency.
     * <p>
     * Examples:
     * 1.
     * Input:   ["Apple", "Horse", "apple", "ApplE", "Minute", "masquerade", "Mask", "water", "Water"]
     * Output:  {APPLE=3, MASQUERADE=1, HORSE=1, MINUTE=1, MASK=1}
     * <p>
     * 2.
     * Input:   ["Word", "A", "AA", "a", "aaa", "aa"]
     * Output:  {AAA=1, WORD=1}
     */
    public Map<String, Long> calculateOddFrequency(List<String> words) {
        return words.stream()
                .map(String::toUpperCase)
                .collect(Collectors.groupingBy(Function.identity(), Collectors.counting()))
                .entrySet()
